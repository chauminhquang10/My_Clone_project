...
import styles from './UpdateUserForm.less';
import closeIcon from '/src/assets/images/svg/icon/close-icon.svg';
...
const UpdateUserForm: React.FC<UpdateFormProps> = ({
  title,
  width,
  visible,
  onVisibleChange,
  ...
  const selectProps: SelectProps = {
    ...
    showSearch: false,
    onDropdownVisibleChange: (open) => (open ? setArrowVisible(false) : setArrowVisible(true)),
    dropdownRender,
  };
      ...
      <Row gutter={[24, 24]} style={{ marginTop: '24px' }}>
        ...
        <Col span={12}>
          <Form.Item name="unitAddress" label="Địa chỉ đơn vị">
            <Tooltip placement="bottomLeft" title={'Chọn đơn vị'}>
