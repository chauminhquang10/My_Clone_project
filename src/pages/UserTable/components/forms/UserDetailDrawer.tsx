...
interface MachineListTableTitleProps {
  title: string;
  quantity: number;
}
...
const UserDetailDrawer: React.FC<UserDrawerProps> = ({
      ...
      render: (text) => (
        <div className={styles.staffNameCell}>
          ...
          <div className={styles.visibleUserDetail}>
            <Tooltip placement="bottom" title={'Chi tiết máy'}>
  ...
  const MachineListTableTitle: React.FC<MachineListTableTitleProps> = ({ title, quantity }) => {
    return (
            ...
            <Row gutter={[0, 24]}>
              ...
              <Col span={24}>
                <Table
                  ...
                  title={() => (
                    <MachineListTableTitle title="Danh sách máy quản lý" quantity={99} />
                  )}
