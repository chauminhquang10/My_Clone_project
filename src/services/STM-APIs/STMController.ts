...
export async function getMachineDetail(
    ...
    return request<API.ResponseBaseStmDetailResponse>(
...
export async function assignMachine(
    ...
    return request<API.ResponseBaseAssignMachineResponse>(
        "/api/v1/machines/access",
        {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
...
/** System operations API  - Get System Operations GET /api/v1/machines/system-operations */
export async function getSystemOperation(
    // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
    params: API.getSystemOperationParams,
    options?: { [key: string]: any }
) {
    return request<API.ResponseBasePageResponseObject>(
