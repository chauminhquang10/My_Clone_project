...
export async function changePassword(
    ...
    return request<API.ResponseBaseChangePasswordResponse>(
...
export async function login(
    ...
    return request<API.ResponseBaseAccessTokenResponseCustom>(
        "/api/v1/auth/login",
        {
            method: "POST",
            headers: {
...
export async function resetPassword(
    ...
    return request<API.ResponseBaseResetPasswordResponse>(
